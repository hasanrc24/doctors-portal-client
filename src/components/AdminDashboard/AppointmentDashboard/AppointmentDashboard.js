...
const AppointmentDashboard = () => {
  ...
  useEffect(() => {
    fetch(
      "https://doctors-portal-server-5nzs.onrender.com/appointmentsByDate",
      {
        method: "POST",
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div style={listStyle} className="">
                <div className="d-flex justify-content-between pt-4 ps-3 pe-3 pb-4">
                  <h6>Appointments</h6>
                      ...
                      <tbody>
                        {appointments.map((app) => (
                          <tr key={app._id}>
                            ...
                            <td>{app.time}</td>
                            <td>
                              <button className="btn">Not Visited</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
